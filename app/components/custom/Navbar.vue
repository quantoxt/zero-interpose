  ...
  >
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 sm:h-20">
        ...
        <NuxtLink
          to="/start"
          class="group relative px-5 sm:px-6 py-2.5 sm:py-3 overflow-hidden rounded-lg text-white transition-all duration-300 hover:shadow-lg hover:scale-105 font-(--zi-font-body)"
