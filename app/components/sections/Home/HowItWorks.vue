  ...
  <section class="relative py-20 sm:py-28 bg-(--zi-background)">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
        ...
        >
          <!-- Step Card -->
          <div class="relative p-8 rounded-2xl border bg-(--zi-background) transition-all duration-300 hover:shadow-xl" style="border-color: var(--zi-border);">
            <!-- Step Number -->
            <div class="absolute -top-4 left-8 w-10 h-10 rounded-full flex items-center justify-center text-lg font-black font-(--zi-font-display)" style="background-color: #8B5CF6; color: white;">
              {{ step.number }}
            </div>
